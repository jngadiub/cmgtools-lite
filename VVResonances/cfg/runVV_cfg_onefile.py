...
if test==1:
    ...
    for c in selectedComponents:
        #c.files = c.files[:1]
	c.files = ['root://eoscms.cern.ch//eos/cms/store/mc/RunIISummer16MiniAODv2/QCD_HT100to200_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/MINIAODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/120000/70BFAF69-FCBD-E611-B0EA-00266CF3E314.root']
        c.splitFactor = 1
elif test==2:
    # test a single component, using a single thread.
