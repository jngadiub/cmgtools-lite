...
# python makeInputs_deepWZHDDT_VH_HPLP.py -p 2016 --run "detector"
# python makeInputs_deepWZHDDT_VH_HPLP.py -p 2016 --run "signorm" --signal "ZprimeWW" --batch False 
# python makeInputs_deepWZHDDT_VH_HPLP.py -p 2016 --run "vjets" --batch False                                                                                                                                      
# python makeInputs_deepWZHDDT_VH_HPLP.py -p 2016 --run "qcdtemplates"
# python makeInputs_deepWZHDDT_VH_HPLP.py -p 2016 --run "qcdkernel"
# python makeInputs_deepWZHDDT_VH_HPLP.py -p 2016 --run "qcdnorm"
# python makeInputs_deepWZHDDT_VH_HPLP.py -p 2016 --run "data"
# python makeInputs_deepWZHDDT_VH_HPLP.py -p 2016 --run "pseudoNOVJETS"
# python makeInputs_deepWZHDDT_VH_HPLP.py -p 2016 --run "pseudoVJETS"                                                                                                                                                                                                                   
