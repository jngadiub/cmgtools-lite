...
# python makeInputs_doubleB.py -p 2016 --run "signorm" --signal "ZprimeWW" --batch False 
# python makeInputs_doubleB.py -p 2016 --run "vjets" --batch False                                                                                                                                      
# python makeInputs_doubleB.py -p 2016 --run "qcdtemplates"
...
# python makeInputs_doubleB.py -p 2016 --run "pseudo"
parser = OptionParser()
...
'''
#MassDecorrelatedDeepBoosted_ZHbbvsQCD
'''
