#!bin/bash
indir=results_2016/
name=2016_VV_VH_scheme2_deepAK8_W_0p05_0p10_ZHbb_0p05_0p10_DDT_defaultMaps_spikekiller_OPT3_0and2_OPTXY0and2_OPTZ1and2_PTZ2and2 #OPT31and1_OPTXY2_OPTZ2
...
#HPHP
#python Projections3DHisto_HPHP.py --mc ${indir}JJ_2016_nonRes_VV_HPHP.root,nonRes -k save_new_shapes_2016_pythia_VV_HPHP_3D.root,histo -o control-plots-QCD_pythia_signals_VV_HPHP_${name}/
#python Projections3DHisto_HPHP.py --mc ${indir}JJ_2016_nonRes_VV_HPHP_altshapeUp.root,nonRes -k save_new_shapes_2016_herwig_VV_HPHP_3D.root,histo -o control-plots-QCD_herwigh_signals_VV_HPHP_${name}
#python Projections3DHisto_HPHP.py --mc ${indir}JJ_2016_nonRes_VV_HPHP_altshape2.root,nonRes -k save_new_shapes_2016_madgraph_VV_HPHP_3D.root,histo -o control-plots-QCD_madgraph_signals_VV_HPHP_${name}/
