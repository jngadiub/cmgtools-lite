...
#background samples
#nonResTemplate="QCD_Pt-" #low stat herwig (altshapeUp)
nonResTemplate="QCD_HT" #medium stat madgraph+pythia (altshape2)
#nonResTemplate="QCD_Pt_" #high stat pythia8 (nominal)
