from functionsVV import *
from optparse import OptionParser
from cutsTau21DoubleB import cuts, HPSF16, HPSF17, LPSF16, LPSF17, dijetbins, HCALbinsMVVSignal, minMJ,maxMJ,binsMJ, minMVV, maxMVV, binsMVV, minMX, maxMX, catVtag, catHtag
## import cuts of the analysis from separate file

# python makeInputsTau21DoubleB.py -p 2016 --run "detector"
# python makeInputsTau21DoubleB.py -p 2016 --run "signorm" --signal "ZprimeWW" --batch False 
# python makeInputsTau21DoubleB.py -p 2016 --run "vjets" --batch False                                                                                                                                      
# python makeInputsTau21DoubleB.py -p 2016 --run "qcdtemplates"
# python makeInputsTau21DoubleB.py -p 2016 --run "qcdkernel"
# python makeInputsTau21DoubleB.py -p 2016 --run "qcdnorm"
# python makeInputsTau21DoubleB.py -p 2016 --run "data"
# python makeInputsTau21DoubleB.py -p 2016 --run "pseudoNOVJETS"
# python makeInputsTau21DoubleB.py -p 2016 --run "pseudoVJETS"                                                                                                                                                                                                                   
...
#all categories
#categories=['VH_HPHP'] #,'VV_HPLP']
#categories=['VH_HPHP','VH_HPLP','VH_LPHP']
#categories=['VH_HPHP','VV_HPHP','VH_HPLP','VV_HPLP'] #,'VBF_VV_HPHP','VBF_VV_HPLP']
...
fixParsSigMVV={"ZprimeZH":{"fixPars":"ALPHA2:2.42,N1:126.5", "pol":"MEAN:pol1,SIGMA:pol1,N1:pol0,ALPHA1:pol5,N2:pol3,ALPHA2:pol0,corr_mean:pol1,corr_sigma:pol1"},
               "WprimeWH":{"fixPars":"ALPHA2:2.42,N1:126.5", "pol":"MEAN:pol1,SIGMA:pol1,N1:pol0,ALPHA1:pol5,N2:pol3,ALPHA2:pol0,corr_mean:pol1,corr_sigma:pol1"},#irene
...
#    for p in categories: makePseudoDataVjets("results_"+str(period)+"/JJ_"+str(period)+"_nonRes_%s.root"%p,"results_"+str(period)+"/save_new_shapes_"+str(period)+"_pythia_%s_3D.root"%p,"pythia","JJ_PDVjets_%s.root"%p,lumi,"results_"+str(period)+"/workspace_JJ_BulkGWW_"+p+"_13TeV_"+str(period)+"_VV_VH_scheme2_deepAK8_W_0p05_0p10_ZHbb_0p05_0p10_DDT_defaultMaps2016_fullStats_prepVjets.root",period,p)
    for p in categories: makePseudoDataVjets("debugSensitivityBulkGWW/VVVH/JJ_"+str(period)+"_nonRes_%s.root"%p,"debugSensitivityBulkGWW/VVVH/save_new_shapes_"+str(period)+"_pythia_%s_3D.root"%p,"pythia","JJ_PDVjets_%s.root"%p,lumi,"debugSensitivityBulkGWW/VVVH/workspace_JJ_BulkGWW_"+p+"_13TeV_"+str(period)+"_VVVH_tau21_doubleB_VjetsPrep.root",period,p)
