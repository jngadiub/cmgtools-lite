...
WLWP="0p05"
WHWP="0p10"
catVtag['HP1'] = '(jj_l1_DeepBoosted_WvsQCD>jj_l1_DeepBoosted_WvsQCD__'+WLWP+'_'+maptype+'_16)' 
catVtag['HP2'] = '(jj_l2_DeepBoosted_WvsQCD>jj_l2_DeepBoosted_WvsQCD__'+WLWP+'_'+maptype+'_16)' 
catVtag['LP1'] = '((jj_l1_DeepBoosted_WvsQCD<jj_l1_DeepBoosted_WvsQCD__'+WLWP+'_'+maptype+'_16)&&(jj_l1_DeepBoosted_WvsQCD>jj_l1_DeepBoosted_WvsQCD__'+WHWP+'_'+maptype+'_16))' 
catVtag['LP2'] = '((jj_l2_DeepBoosted_WvsQCD<jj_l2_DeepBoosted_WvsQCD__'+WLWP+'_'+maptype+'_16)&&(jj_l2_DeepBoosted_WvsQCD>jj_l2_DeepBoosted_WvsQCD__'+WHWP+'_'+maptype+'_16))' 
catVtag['NP1'] = '(jj_l1_DeepBoosted_WvsQCD<jj_l1_DeepBoosted_WvsQCD__'+WHWP+'_'+maptype+'_16)' 
catVtag['NP2'] = '(jj_l2_DeepBoosted_WvsQCD<jj_l2_DeepBoosted_WvsQCD__'+WHWP+'_'+maptype+'_16)' 


print "################     you are using DeepAK8 ZHbbvsQCD  with fixed mistag rate !!  !!!!! #########"  
HLWP="0p02"
HHWP="0p10"
catHtag['HP1'] = '(jj_l1_DeepBoosted_ZHbbvsQCD>jj_l1_DeepBoosted_ZHbbvsQCD__'+HLWP+'_'+maptype+'_16)' 
catHtag['HP2'] = '(jj_l2_DeepBoosted_ZHbbvsQCD>jj_l2_DeepBoosted_ZHbbvsQCD__'+HLWP+'_'+maptype+'_16)' 
catHtag['LP1'] = '((jj_l1_DeepBoosted_ZHbbvsQCD<jj_l1_DeepBoosted_ZHbbvsQCD__'+HLWP+'_'+maptype+'_16)&&(jj_l1_DeepBoosted_ZHbbvsQCD>jj_l1_DeepBoosted_ZHbbvsQCD__'+HHWP+'_'+maptype+'_16))' 
catHtag['LP2'] = '((jj_l2_DeepBoosted_ZHbbvsQCD<jj_l2_DeepBoosted_ZHbbvsQCD__'+HLWP+'_'+maptype+'_16)&&(jj_l2_DeepBoosted_ZHbbvsQCD>jj_l2_DeepBoosted_ZHbbvsQCD__'+HHWP+'_'+maptype+'_16))' 
catHtag['NP1'] = '(jj_l1_DeepBoosted_ZHbbvsQCD<jj_l1_DeepBoosted_ZHbbvsQCD__'+HLWP+'_'+maptype+'_16)' 
catHtag['NP2'] = '(jj_l2_DeepBoosted_ZHbbvsQCD<jj_l2_DeepBoosted_ZHbbvsQCD__'+HLWP+'_'+maptype+'_16)' 
cuts={}
