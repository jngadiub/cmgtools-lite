...
auto getZHcut(const Double_t pt, const Double_t mass, TString filename = "MapsDeltaEta/DDTMap_ZHbbvsQCD_scaled_2018_withDeltaEta_finerbinning/myDeepBoostedMap_0p10rho.root", TString mapName = "DeepBoosted_ZHbbvsQCD_v_rho_v_pT_scaled_yx_0p10" ){
...
//auto getZHcut2(const Double_t pt, const Double_t mass, TString filename = "MapsDeltaEta/DDTMap_ZHbbvsQCD_scaled_2018_withDeltaEta_finerbinning/myDeepBoostedMap_0p8rho_smoothed.root", TString mapName = "DeepBoosted_ZHbbvsQCD_v_rho_v_pT_scaled_0p8_map_dijet" ){
 auto getZHcut2(const Double_t pt, const Double_t mass, TString filename = "MapsDeltaEta/DDTMap_ZHbbvsQCD_scaled_2018_withDeltaEta_finerbinning/myDeepBoostedMap_0p20rho.root", TString mapName = "DeepBoosted_ZHbbvsQCD_v_rho_v_pT_scaled_yx_0p20" ){
...
auto getWcut(const Double_t pt, const Double_t mass, TString filename = "DDTMap_WvsQCD_scaled_2016_withDeltaEta_finerbinning/myDeepBoostedMap_0p95rho_smoothed.root", TString mapName = "DeepBoosted_WvsQCD_v_rho_v_pT_scaled_0p95_map_dijet" ){
